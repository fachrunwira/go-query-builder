...
func (q *queryStruct) Where(column string, values any) manipulateOrQuerying {
...
func (q *queryStruct) WhereRaw(query string, bindings ...any) manipulateOrQuerying {
	if len(q.whereClause) > 0 {
...
func (q *queryStruct) WhereNot(column string, values any) manipulateOrQuerying {
	if len(q.whereClause) > 0 {
...
func (q *queryStruct) OrWhereRaw(query string, bindings ...any) manipulateOrQuerying {
	if len(q.whereClause) > 0 {
...
func (q *queryStruct) OrWhere(column string, values any) manipulateOrQuerying {
	if len(q.whereClause) > 0 {
...
func (q *queryStruct) OrWhereNot(column string, values any) manipulateOrQuerying {
	if len(q.whereClause) > 0 {
...
func (q *queryStruct) WhereIn(column string, values []any) manipulateOrQuerying {
	if len(values) == 0 {
...
func (q *queryStruct) WhereNotIn(column string, values []any) manipulateOrQuerying {
	if len(values) == 0 {
		q.errors = fmt.Errorf("no where in value bindings detected")
		return q
	}
...
func (q *queryStruct) OrWhereIn(column string, values []any) manipulateOrQuerying {
	if len(values) == 0 {
		q.errors = fmt.Errorf("no where in value bindings detected")
		return q
	}
...
func (q *queryStruct) OrWhereNotIn(column string, values []any) manipulateOrQuerying {
	if len(values) == 0 {
		q.errors = fmt.Errorf("no where in value bindings detected")
		return q
	}
